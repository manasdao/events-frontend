        ...
        <div className="px-4 py-5 sm:p-6">
          <div className="sm:flex">
            ...
            <div className="mb-4 flex justify-center sm:mb-0 sm:mr-4">
              {sponsordetails.fields?.Twitter ||
              sponsordetails.fields?.calendly ? (
                <QRCode
                  value={
                    sponsordetails.fields?.Twitter ||
                    sponsordetails.fields?.calendly ||
            ...
            <div className="flex items-center mx-auto w-full justify-center">
              <SocialIcon
                url={
                  sponsordetails.fields?.Twitter ||
                  sponsordetails.fields?.calendly ||
                  "https://twitter.com/tripathigrows"
                }
                className="mx-4"
              />
              <SocialIcon
